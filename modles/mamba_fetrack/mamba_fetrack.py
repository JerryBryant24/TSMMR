...
# from lib.models.mamba_fetrack.models_mamba_paper2 import create_block
# from lib.models.mamba_fetrack.models_mamba_resnet import create_block
from lib.models.mamba_fetrack.models_mamba_paper3 import create_block
...
#############################LXQ 新增 ##############################
        ...
        # rgb_feature = self.backbone.forward_features(z=template, x=search, z2=event_template, nlp_word=nlp_word,# [B, 320, 384]
        #                                              inference_params=None, if_random_cls_token_position=False,
        #                                              if_random_token_rank=False, mask=None)

        rgb_feature = self.backbone.forward_features(z=template, x=search, nlp_enb=nlp_word,# [B, 320, 384]
                                                     inference_params=None, if_random_cls_token_position=False,
                                                     if_random_token_rank=False, mask=None)
